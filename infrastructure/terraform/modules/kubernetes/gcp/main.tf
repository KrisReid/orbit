...
# -----------------------------------------------------------------------------
# Service Account for Nodes (if not provided)
# -----------------------------------------------------------------------------
...
locals {
  node_service_account = var.node_service_account != null ? var.node_service_account : google_service_account.node[0].email
}
