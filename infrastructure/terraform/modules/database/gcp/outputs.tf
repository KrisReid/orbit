# =============================================================================
# GCP Cloud SQL PostgreSQL Module - Outputs
# =============================================================================
...
output "secret_id" {
  description = "The Secret Manager secret ID containing the credentials"
...
output "secret_name" {
  ...
  value       = var.create_secret ? google_secret_manager_secret.db_credentials[0].name : null
}
