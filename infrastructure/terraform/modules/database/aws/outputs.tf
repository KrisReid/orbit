...
output "secret_arn" {
  ...
  value       = var.create_secret ? aws_secretsmanager_secret.db_credentials[0].arn : null
}

output "secret_name" {
  description = "The name of the Secrets Manager secret"
  value       = var.create_secret ? aws_secretsmanager_secret.db_credentials[0].name : null
}
