...
# AWS VPC Module
# =============================================================================
# Creates a VPC with subnets optimized for EKS deployment.
# =============================================================================
...
resource "aws_eip" "nat" {
  count  = var.enable_nat ? var.single_nat_gateway ? 1 : length(local.azs) : 0
  domain = "vpc"
...
resource "aws_route_table_association" "private" {
  ...
  route_table_id = var.enable_nat ? aws_route_table.private[var.single_nat_gateway ? 0 : count.index].id : aws_route_table.public.id
}
