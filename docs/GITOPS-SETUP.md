...
The database connection string is a sensitive value generated by Terraform. To securely provide it to your application, you'll create a Kubernetes secret from the Terraform output. This manual step prevents sensitive credentials from being automatically passed between systems.
