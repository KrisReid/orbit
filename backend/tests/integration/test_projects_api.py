...
class TestProjectTypesEndpoints:
    ...
    async def test_list_project_types(
        self, client: AsyncClient, test_user: User, test_project_type: ProjectType, auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.xfail(reason="App bug: MissingGreenlet due to lazy-loaded relationships in response")
    async def test_update_project_type(
        self, client: AsyncClient, admin_user: User, test_project_type: ProjectType, admin_headers: dict
    ):
...
class TestProjectsEndpoints:
    ...
    async def test_list_projects(
        self, client: AsyncClient, test_user: User, test_project: Project, auth_headers: dict
    ):
    ...
    async def test_list_projects_with_filters(
        ...
        test_project_type: ProjectType, auth_headers: dict
    ):
    ...
    async def test_create_project_with_theme(
        self, client: AsyncClient, test_user: User, test_project_type: ProjectType,
        test_theme: Theme, auth_headers: dict
    ):
    ...
    async def test_delete_project_as_admin(
        self, client: AsyncClient, admin_user: User, admin_headers: dict,
        test_project_type: ProjectType, db_session
    ):
