...
from app.domain.services.project import ProjectService, ProjectTypeService, generate_slug
...
class TestProjectTypeService:
    ...
    @pytest.fixture
    def project_type_service(self, mock_session, mock_project_type_repo, mock_project_repo):
    ...
    async def test_get_stats(
        self, project_type_service, mock_project_type_repo, mock_project_repo, sample_project_type
    ):
...
class TestProjectService:
    ...
    @pytest.fixture
    def project_service(
        self, mock_session, mock_project_repo, mock_project_type_repo,
        mock_theme_repo, mock_task_repo
    ):
    ...
    async def test_create_project_success(
        self, project_service, mock_project_repo, mock_project_type_repo,
        sample_project_type, sample_project
    ):
    ...
    async def test_create_project_with_theme(
        self, project_service, mock_project_repo, mock_project_type_repo,
        mock_theme_repo, sample_project_type, sample_theme, sample_project
    ):
    ...
    async def test_create_project_invalid_theme(
        self, project_service, mock_project_type_repo, mock_theme_repo, sample_project_type
    ):
    ...
    async def test_get_task_count(
        self, project_service, mock_task_repo
    ):
